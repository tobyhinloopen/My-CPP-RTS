...
DamageReport damage_each_component(const ComponentSet & components, int damage);

UnitDamageManager::UnitDamageManager(const std::shared_ptr<const ComponentSet> components)
